    ...
    <transition name="el-fade-in-linear">
      ...
      >
        <div class="Box_right">
          ...
          <header>时间段</header>
          <div class="main">
            <el-time-picker v-model="value2" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value2)}}
            </span>
            <el-time-picker v-model="value3" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value3)}}
            </span>
            <el-time-picker v-model="value4" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value4)}}
            </span>
            <el-time-picker v-model="value5" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value5)}}
            </span>
            <el-time-picker v-model="value6" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value6)}}
            </span>
            <el-time-picker v-model="value7" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value7)}}
            </span>
            <el-time-picker v-model="value8" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value8)}}
            </span>
            <el-time-picker v-model="value9" value-format="HH:mm" :clearable="false" format="HH:mm"></el-time-picker>
            <span>
              <i>——</i>
              {{setTimeOut(value9)}}
            </span>
...
export default {
  ...
  methods: {
    ...
    SubmitTime() {
      ...
      this.deleteData();
      this.$http
        .post(this.$conf.env.createdPitchTime, params)
        .then(res => {
          console.log(res);
